...
const Header = () => {
    ...
    const handleProfile = () => {
        setBackround(`linear-gradient(rgba(77,87,101,0.7), rgba(4,9,30,0.7))`)
        setProfileHeight('50vh')
        setProfileMargin('80%')
        setAbout(false);
        setProfile(true);
        setStudyG(false);
