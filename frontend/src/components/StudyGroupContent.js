                ...
                { data.results?.map((value) => (
                    <div class="tile" key={value._id}>
                        ...
                        <div class="tile-footer">
                            ...
                            <div>
                                <button class="join-btn" a-key={value.groupName} onClick={(e) => { currentUser.username === '' ? navigate("/login") : fetchData(e.target.getAttribute("a-key"))}} onClickCapture ={(e) => {currentUser.username === '' ? navigate("/login") : setPassedName(e.target.getAttribute('a-key'))}}>Join Group</button>
                                <button class="review-btn" a-key={value.groupName} onClick={(e) =>{ currentUser.username === '' ? navigate("/login") : modalSetUp(e.target.getAttribute("a-key"))}} onClickCapture={currentUser.username === '' ? navigate("/login") : handleShow}>Leave Review</button>
