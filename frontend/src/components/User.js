    ...
    return(
      <div id="userDiv">
        ...
        <form onSubmit ={doUser}>
          <input className='input-field mt-3' type="text" id="userFirstName" value={currentUser.firstName !== '' ? currentUser.firstName : "New First Name"} ref={(c) => userFirstName = c} /><br />
          <input className='input-field mt-3' type="text" id="userLastName" value={currentUser.lastName !== '' ? currentUser.lastName : "New Last Name"}  ref={(c) => userLastName = c} /><br />
          <input className='input-field mt-3' type="text" id="userPhoneNumber" value= {currentUser.phone !== '' ? currentUser.phone : "New Phone"} ref={(c) => userPhoneNumber = c} /><br />
